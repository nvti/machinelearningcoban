...
w_init = np.array([[2], [1]])
(w1, it1) = SGD_NAG(w_init, sgrad, .1, .3)
print('Solution found by SGD NAG: w = ',
...
anim.save('SGD_NAG_ex2.gif', dpi=80, writer='imagemagick')
...
anim1.save('SGD_NAG_ex2_contours.gif', dpi=100, writer='imagemagick')
...
plt.xlabel('iter')
plt.ylabel('loss')
plt.title('LR with SGD NAG, first 50 iters')
plt.savefig('SGD_NAG_ex2_loss.png')
