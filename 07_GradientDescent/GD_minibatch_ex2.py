...
def GD_minibatch(w_init, grad, eta):
    w = [w_init]
    w_last_check = w_init
    N = X.shape[0]
...
w_init = np.array([[2], [1]])
(w1, it1) = GD_minibatch(w_init, sgrad, .5)
...
anim.save('GD_minibatch_ex2.gif', dpi=80, writer='imagemagick')
...
anim1.save('GD_minibatch_ex2_contours.gif', dpi=100, writer='imagemagick')
...
plt.savefig('GD_minibatch_ex2_loss.png')
