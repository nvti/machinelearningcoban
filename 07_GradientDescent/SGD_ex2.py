...
w_init = np.array([[2], [1]])
(w1, it1) = SGD(w_init, sgrad, .1)
print('Solution found by SGD: w = ',
...
anim.save('SGD_ex2.gif', dpi=80, writer='imagemagick')
...
anim1.save('SGD_ex2_contours.gif', dpi=100, writer='imagemagick')
